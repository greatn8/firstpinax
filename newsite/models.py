...
class Project(models.Model):
    ...
    PROJ_START_DATE_DETAIL = models.CharField(max_length=120, blank=False, null=True)
    PROJ_END_DATE_DETAIL = models.CharField(max_length=120, blank=False, null=True)
